            ...
            <td align="center" bgcolor="#eff3f8">
                                                                    ...
                                                                    <a href="#" target="_blank"
                                                                       style="color: #596167; font-family: Arial, Helvetica, sans-serif; font-size: 13px;">
                                                                        <font face="Arial, Helvetica, sans-seri; font-size: 13px;"
                                                                              size="3" color="#596167">
                                                                            <%--<img src="http://artloglab.com/metromail/images/logo.gif"--%>
				...
				Item -->
                                                                                    ...
                                                                                    <%--<a href="#" target="_blank"--%>
                                                                                       <%--style="color: #596167; font-family: Arial, Helvetica, sans-serif; font-size: 12px;">--%>
                                                                                        <%--<font face="Arial, Helvetica, sans-serif"--%>
                                                                                              <%--size="2" color="#596167">--%>
                                                                                            <%--<img src="http://artloglab.com/metromail/images/facebook.gif"--%>
                                                                                                 <%--width="10" height="19"--%>
                                                                                                 <%--alt="Facebook"--%>
                                                                                                 <%--border="0"--%>
                                                                                                 <%--style="display: block;"/></font></a>--%>
                                                                                ...
                                                                                <%--<td width="39" align="center"--%>
                                                                                    ...
                                                                                    <%--<a href="#" target="_blank"--%>
                                                                                       <%--style="color: #596167; font-family: Arial, Helvetica, sans-serif; font-size: 12px;">--%>
                                                                                        <%--<font face="Arial, Helvetica, sans-serif"--%>
                                                                                              <%--size="2" color="#596167">--%>
                                                                                            <%--<img src="http://artloglab.com/metromail/images/twitter.gif"--%>
                                                                                                 <%--width="19" height="16"--%>
                                                                                                 <%--alt="Twitter"--%>
                                                                                                 <%--border="0"--%>
                                                                                                 <%--style="display: block;"/></font></a>--%>
                                                                                ...
                                                                                <%--<td width="29" align="right"--%>
                                                                                    ...
                                                                                    <%--<a href="#" target="_blank"--%>
                                                                                       <%--style="color: #596167; font-family: Arial, Helvetica, sans-serif; font-size: 12px;">--%>
                                                                                        <%--<font face="Arial, Helvetica, sans-serif"--%>
                                                                                              <%--size="2" color="#596167">--%>
                                                                                            <%--<img src="http://artloglab.com/metromail/images/dribbble.gif"--%>
                                                                                                 <%--width="19" height="19"--%>
                                                                                                 <%--alt="Dribbble"--%>
                                                                                                 <%--border="0"--%>
                                                                                                 <%--style="display: block;"/></font></a>--%>
					...
					<span style="font-family: Arial, Helvetica, sans-serif; font-size: 15px; color: #57697e;">
						We are a part of the CSI Community<br>Come, grow with us!
					</span></font>
                                        </div>
                                        <!-- padding -->
                                        <div style="height: 40px; line-height: 40px; font-size: 10px;"></div>
                                ...
                                <tr>
                                    <td align="center">
                                        <div style="line-height: 24px;">
                                            <a href="<%=Misc.getBaseUrl(request)%>" target="_blank"
                                               style="color: #596167; font-family: Arial, Helvetica, sans-serif; font-size: 13px;">
                                                <font face="Arial, Helvetica, sans-seri; font-size: 13px;" size="3"
                                                      color="#596167">
                                                    <%--<img src="http://artloglab.com/metromail/images/trial.gif"--%>
                                                         <%--width="193" height="43" alt="30-DAYS FREE TRIAL" border="0"--%>
                                                         <%--style="display: block;"/></font></a>--%>
                                                        <h3>Head over to the site!</h3>
                                        </div>
                                        <!-- padding -->
                                        <div style="height: 60px; line-height: 60px; font-size: 10px;"></div>
                                    </td>
                                                            ...
                                                            <font face="Arial, Helvetica, sans-serif" size="3"
                                                                ...
                                                                <strong style="font-family: Arial, Helvetica, sans-serif; font-size: 14px; color: #4db3a4;">
                                                                    <a href="#1" target="_blank"
                                                                       style="color: #4db3a4; text-decoration: none;">UNLIMITED
                                                                        LAYOUTS</a>
                                                                </strong></font>
                                                        </div>
                                                        <!-- padding -->
                                                            ...
                                                            <font face="Arial, Helvetica, sans-serif" size="3"
                                                                ...
                                                                <strong style="font-family: Arial, Helvetica, sans-serif; font-size: 14px; color: #4db3a4;">
                                                                    <a href="#2" target="_blank"
                                                                       style="color: #4db3a4; text-decoration: none;">GREAT
                                                                        SUPPORT</a>
                                                                </strong></font>
                                                        </div>
                                                        <!-- padding -->
                                                            ...
                                                            <font face="Arial, Helvetica, sans-serif" size="3"
                                                                ...
                                                                <strong style="font-family: Arial, Helvetica, sans-serif; font-size: 14px; color: #4db3a4;">
                                                                    <a href="#3" target="_blank"
                                                                       style="color: #4db3a4; text-decoration: none;">CLEAN
                                                                        CODE</a>
                                                                </strong></font>
                                                        </div>
                                                        <!-- padding -->
                    ...
                    <tr>
		              ...
		              <img src="http://artloglab.com/metromail/images/dot.gif" alt="|" width="9" height="9"
                               class="mob_display_none"/>
                                ...
                                <tr>
                                    <td align="center">
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td align="center">
                                                    <font face="Arial, Helvetica, sans-serif" size="3" color="#57697e"
                                                            ...
                                                            <a href="#" target="_blank"
                                                               style="color: #596167; font-family: Arial, Helvetica, sans-serif; font-size: 12px;">
                                                                <font face="Arial, Helvetica, sans-serif" size="2"
                                                                      color="#596167">
                                                                    <img src="http://artloglab.com/metromail/images/img1.jpg"
                                                                         width="185" alt="Image 1" border="0"
                                                                         style="display: block; width: 100%; height: auto;"/></font></a>
                                                        </div>
                                                    </td>
                                                </tr>
                                            </table>
                                                        ...
                                                        <div style="line-height: 14px;">
                                                            <a href="#" target="_blank"
                                                               style="color: #596167; font-family: Arial, Helvetica, sans-serif; font-size: 12px;">
                                                                <font face="Arial, Helvetica, sans-serif" size="2"
                                                                      color="#596167">
                                                                    <img src="http://artloglab.com/metromail/images/img2.jpg"
                                                                         width="185" alt="Image 2" border="0"
                                                                         style="display: block; width: 100%; height: auto;"/></font></a>
                                                        </div>
                                                    </td>
                                                </tr>
                                                        ...
                                                        <div style="line-height: 14px;">
                                                            <a href="#" target="_blank"
                                                               style="color: #596167; font-family: Arial, Helvetica, sans-serif; font-size: 12px;">
                                                                <font face="Arial, Helvetica, sans-serif" size="2"
                                                                      color="#596167">
                                                                    <img src="http://artloglab.com/metromail/images/img3.jpg"
                                                                         width="185" alt="Image 3" border="0"
                                                                         style="display: block; width: 100%; height: auto;"/></font></a>
                                                        </div>
                                                    </td>
                                                </tr>
                                            ...
                                            <table class="mob_100" width="100%" border="0" cellspacing="0"
                                                ...
                                                <tr>
                                                    <td align="center" style="line-height: 14px; padding: 0 24px;">
                                                        <!-- padding -->
                                                        <div style="height: 30px; line-height: 30px; font-size: 10px;">
                                                        ...
                                                        <div style="line-height: 14px;">
                                                            <a href="#" target="_blank"
                                                               style="color: #596167; font-family: Arial, Helvetica, sans-serif; font-size: 12px;">
                                                                <font face="Arial, Helvetica, sans-serif" size="2"
                                                                      color="#596167">
                                                                    <img src="http://artloglab.com/metromail/images/evernote.gif"
                                                                         width="125" alt="Evernote" border="0"
                                                                         class="mob_width_50"
                                                                         style="display: block; width: 100%; height: auto;"/></font></a>
                                                        </div>
                                                    </td>
                                                        ...
                                                        <div style="line-height: 14px;">
                                                            <a href="#" target="_blank"
                                                               style="color: #596167; font-family: Arial, Helvetica, sans-serif; font-size: 12px;">
                                                                <font face="Arial, Helvetica, sans-serif" size="2"
                                                                      color="#596167">
                                                                    <img src="http://artloglab.com/metromail/images/pinterest.gif"
                                                                         width="107" alt="Pinterest" border="0"
                                                                         class="mob_width_50"
                                                                         style="display: block; width: 100%; height: auto;"/></font></a>
                                                        </div>
                                                    </td>
                                                        ...
                                                        <div style="line-height: 14px;">
                                                            <a href="#" target="_blank"
                                                               style="color: #596167; font-family: Arial, Helvetica, sans-serif; font-size: 12px;">
                                                                <font face="Arial, Helvetica, sans-serif" size="2"
                                                                      color="#596167">
                                                                    <img src="http://artloglab.com/metromail/images/ng.gif"
                                                                         width="103" alt="National Geographic"
                                                                         border="0" class="mob_width_50"
                                                                         style="display: block; width: 100%; height: auto;"/></font></a>
                                                        </div>
                                                    </td>
                                                </tr>
                                                        ...
                                                        <div style="line-height: 14px;">
                                                            <a href="#" target="_blank"
                                                               style="color: #596167; font-family: Arial, Helvetica, sans-serif; font-size: 12px;">
                                                                <font face="Arial, Helvetica, sans-serif" size="2"
                                                                      color="#596167">
                                                                    <img src="http://artloglab.com/metromail/images/shopify.gif"
                                                                         width="116" alt="Shopify" border="0"
                                                                         class="mob_width_50"
                                                                         style="display: block; width: 100%; height: auto;"/></font></a>
                                                        </div>
                                                    </td>
