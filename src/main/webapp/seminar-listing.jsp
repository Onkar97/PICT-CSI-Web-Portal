        ...
        <div class="row">
            ...
            <%
                try(Connection connection = DatabaseConnection.getConnection()){
                    String sql = "SELECT * FROM EVENT where has_ended = 0 and event_type = 'Seminar' AND end_date > NOW() ORDER BY event_id";
            ...
            <div class="col-12 col-sm-6 col-lg-4">
                <a href="seminar-reg.jsp?event_id=<%=e.getEvent_id()%>" onclick="return(checking());">
...
<section class="dorne-listing-destinations-area section-padding-100-50">
    <div class="container">
        ...
        <div class="row">
            ...
            <%
                try(Connection connection = DatabaseConnection.getConnection()){
                    String sql = "SELECT * FROM EVENT where event_type = 'Seminar' AND end_date < NOW() ORDER BY event_id";
                    ResultSet set = DatabaseConnection.getResultSet(connection, sql);
                    while(set.next()){
                        Event e = Event.getFromSet(set);
