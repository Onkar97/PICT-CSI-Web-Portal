        ...
        <div class="row">
            ...
            <%
                try (Connection connection = DatabaseConnection.getConnection()){
                    ...
                    String sql = "SELECT * FROM EVENT where event_type = 'Workshop' AND end_date > NOW() ORDER BY event_id";
            ...
            <div class="col-12 col-sm-6 col-lg-4">
                <a href="workshop-reg.jsp?event_id=<%=e.getEvent_id()%>" onclick="return(checking());">
