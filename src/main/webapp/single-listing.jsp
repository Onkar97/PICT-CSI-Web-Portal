...
<%
    ...
    try (Connection connection = DatabaseConnection.getConnection()) {
        ...
        String sql = "SELECT * FROM EVENT WHERE has_ended = 0 and event_id=" + ID;
        ResultSet set = DatabaseConnection.getResultSet(connection, sql);
        if (set.next()) {
            e = Event.getFromSet(set);
            try {
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-12 col-lg-6">
                <div class="single-listing-content">
                    ...
                    <%--<div class="listing-title">--%>
                        <%--<h1><%=e.getEvent_name()%>--%>
                        <%--</h1>--%>
                        <%--<h6>START DATE ::<%=e.getStart_date()%>--%>
                        <%--</h6>--%>
                        <%--<h6>END DATE ::<%=e.getEnd_date()%>--%>
                        <%--</h6>--%>
                        <%--<h6>Max Seats ::<%=e.getMax_seats()%>--%>
                        <%--</h6--%>
                        <%--<h6>Event Fees ::<%=e.getEvent_fee()%>--%>
                        <%--</h6>--%>
                    <%--</div>--%>
            ...
            <div class="col-12 col-md-8 col-lg-6">
                <div class="listing-sidebar">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <input type="text" name="participant_name" class="form-control"
                                           ...
                                           value='<%=user.getFirst_name() + " " + (user.getLast_name() != null ? user.getLast_name() : "")%>'>
                                </div>
                                <div class="col-12">
                                    Event Name:
                                    <input type="text" name="event_name" class="form-control" placeholder="Event Name"
                                           value='<%=e.getEvent_name()%>'>
                                </div>
                                <div class="col-12">
                                    Event Type:
                                    <input type="text" name="event_type" class="form-control" placeholder="Event Name"
                                           value='<%=e.getEvent_type()%>'>
                                </div>
                                <div class="col-12">
                                    Fees:
                                    <input type="text" name="fees_name" class="form-control" placeholder="Fees"
                                           value='<%=e.getEvent_fee()%>'>
                                </div>
                                <div class="col-12">
                                   Details for payment will be sent on mail
                                </div>
                                <div class="col-12">
                                    Category:
                                    <div class="form-check">
                                        <label class="form-check-label">
                                            <input class="form-check-input" name="category" id="r1" value="junior"
                                                   checked="" type="radio">
                                            Junior <span style="margin-left:70px;">
                                                 <input class="form-check-input" name="category" id="r2" value="senior"
                                                        type="radio">
                                                  Senior
                                                  </span>
                                        </label>
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="form-check">
                                        <label class="form-check-label">
                                            <input class="form-check-input" name="group1" id="r3" value="INDIVIDUAL"
                                                   checked="" type="radio">
                                            Individual <span style="margin-left:70px;">
                                                 <input class="form-check-input" name="group1" id="r4" value="GROUP"
                                                        type="radio">
                                                  Group
                                                  </span>
                                        </label>
                    ...
                    %>
                    <a href="#" style="color: #000;" data-toggle="modal" data-target="#loginModal">Sign in to register
                        for event</a>
                    <%
                        }
                    %>
                    <%--<div class="opening-hours-widget mt-50">--%>
                        ...
                        <%--<ul class="opening-hours">--%>
                            <%--<li>--%>
                                <%--<h3 style="color: whitesmoke"><p><%=e.getEvent_name()%>--%>
                                <%--</p></h3>--%>
                                <%--<%--%>
                                ...
                                <%--<p>Only <%=cstmt.getInt(2)%>% of Seats Remaining</p>--%>
                                <%--<%--%>
                                    <%--} catch (Exception p) {--%>
                                        <%--p.printStackTrace();--%>
                                    <%--}--%>
