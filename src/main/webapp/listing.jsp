        ...
        <div class="row">
            ...
            <%
                try (Connection connection = DatabaseConnection.getConnection()) {
                    ...
                    String sql = "SELECT * FROM EVENT where event_type = 'Event' AND end_date > NOW() ORDER BY event_id";
            ...
            <div class="col-12 col-sm-6 col-lg-4">
                <a href="single-listing.jsp?event_id=<%=e.getEvent_id()%>" onclick="return(checking());">
                    ...
                    <div class="single-features-area mb-50">
                        <img src="data:image/png;base64,<%=Base64.getEncoder().encodeToString(e.getImage().getBytes(1, (int) e.getImage().length()))%>"
                             alt="">
                        <!-- Price -->
                        <div class="price-start">
                            <p>FROM Rs.<%=e.getEvent_fee()%>
                            </p>
                        </div>
