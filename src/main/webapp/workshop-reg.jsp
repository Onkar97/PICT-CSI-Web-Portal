...
<%
    ...
    try(Connection connection = DatabaseConnection.getConnection()){
        ...
        String sql = "SELECT * FROM EVENT WHERE event_type = 'Workshop' AND event_id="+ID;
                    ...
                    <div class="contact-form contact-form-widget mt-50" style="color: white">
                        ...
                        <form action="/EventRegServlet" method="post">
                            ...
                            <div class="row">
                                ...
                                <%--<div class="form-check">--%>
                                <%--<label class="form-check-label">--%>
                                <%--<input class="form-check-input" name="group1" id="r3" value="Individual" checked="" type="radio">--%>
                                <%--Individual <span style="margin-left:70px;">--%>
                                <%--<input class="form-check-input" name="group1" id="r4" value="Group" type="radio">--%>
                                <%--Group--%>
                                <%--</span>--%>
                                <%--</label>--%>
                                <%--</div>--%>
